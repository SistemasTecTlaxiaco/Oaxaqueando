 ...
 *
 * @package Shoper WordPress theme
 */
...
$products_per_page = get_theme_mod( 'shoper_posts_per_page', '12' );
...
<ul class="result-count">
    <li class="view-title"><?php echo esc_html__('View:','shoper'); ?>
	</li>
    ...
    <li><a class="view-all<?php if ( $num_prod == 'all' ) echo esc_attr('active'); ?>" href="<?php echo esc_url( add_query_arg( 'products-per-page', 'all', $link  ) ) ?>"><?php echo esc_html__('ALL:','shoper'); ?></a></li>
</ul>
